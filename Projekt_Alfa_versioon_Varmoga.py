...
varmo = pygame.image.load('varmo1.png').convert()
varmo = pygame.transform.scale(varmo, (50, 50))
varmo.set_colorkey((0, 0, 0))
running = True
x = y = 10
...
while running:
    ...
    varmo_rect = pygame.Rect(x, y, 50, 50)
